                        ...
                        <div class="styled-form login-form">
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="name-input" name="owner_name" placeholder="Enter Owner Name " pattern="^[A-Za-z -]+$" class="form-control" class="required" required>
                                </div>

                                <div class="form-group">
                                    <span class="adon-icon"><span class="fa fa-envelope"></span></span>
                                    <input type="email" id="email-input" name="owner_email" placeholder="Enter Your Email " pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" class="form-control" class="required" required>

                                </div>

                                <div class="form-group">
                                    <span class="adon-icon"><span class="fa fa-unlock"></span></span>
                                    <input type="password" id="password-input" name="owner_password" placeholder="Enter Password" class="form-control" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" class="required" required>
                                </div>

                                <div class="form-group">
                                    <span class="adon-icon"></span>
                                    <input type="text" id="number-input" name="owner_mobileno" placeholder="Enter Mobile No" class="form-control" pattern="[0-9]{10}" class="required" required>
                                </div>

                                <div class="form-group">
                                    <span class="adon-icon"><span class=""></span></span>
                                    <textarea name="owner_address" id="textarea-input" rows="9" placeholder="Enter Owner Address" class="form-control" class="required" required></textarea>
                                </div>
